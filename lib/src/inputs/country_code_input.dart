...
enum CountryCodeError { empty, invalid }

class CountryCode extends FormzInput<String, CountryCodeError> {
  /// Default list of dialing codes. Pass [validCodes] to the constructor to
  /// restrict (or extend) which codes are accepted by a given app.
  static const List<String> defaultValidCodes = [
    ...
    '+1345', '+1441', '+1473', '+1649', '+1664', '+1670', '+1671', '+1684', '+1721',
    '+1758', '+1767', '+1784', '+1787', '+1809', '+1829', '+1849', '+1868', '+1869',
    '+1876', '+1907', '+1939'
  ];
  ...
  String? get errorMessage {
    ...
    if (displayError == CountryCodeError.empty) return 'El campo es obligatorio';
    if (displayError == CountryCodeError.invalid) return 'Código de país no válido';
  ...
  CountryCodeError? validator(String value) {
    if (value.trim().isEmpty) return CountryCodeError.empty;
    if (!validCodes.contains(value)) return CountryCodeError.invalid;
